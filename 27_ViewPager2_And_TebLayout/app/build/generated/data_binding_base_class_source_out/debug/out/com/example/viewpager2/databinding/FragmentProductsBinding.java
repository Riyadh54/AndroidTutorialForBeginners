...
public final class FragmentProductsBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView fragmentRv;

  private FragmentProductsBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView fragmentRv) {
    this.rootView = rootView;
    this.fragmentRv = fragmentRv;
  }
  ...
  public static FragmentProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fragment_rv;
      RecyclerView fragmentRv = ViewBindings.findChildViewById(rootView, id);
      if (fragmentRv == null) {
        break missingId;
      }

      return new FragmentProductsBinding((FrameLayout) rootView, fragmentRv);
    }
